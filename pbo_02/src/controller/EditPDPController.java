 ...
 * @author ITD
 */
public class EditPDPController implements Initializable {
    ...
    @FXML
    void onClickEditPDP(ActionEvent event) {
     Api api = RetrofitClient.getRetrofit().create(Api.class);
           System.out.println(id);
           Preferences preferences = Preferences.userRoot(); 
    
            api.updatePdp(id, tf_tanggal.getText().toString(), tf_jumlah.getText().toString())
                .enqueue(new Callback<ResponseBody>(){
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if(response.isSuccessful()){
                            ...
                            Platform.runLater(() -> {   
                                try{
                                    FXMLLoader pinda2 = new FXMLLoader(getClass().getResource("/view/Kelola_kasusPDP.fxml"));
